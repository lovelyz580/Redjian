...
import com.wechat.bus.entity.User;
...
public class UserDao {
    ...
    public int insertByUser(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            num = session.insert("com.wechat.bus.dao.mapper.User.insertByUser", user);
        } catch (Exception e) {
    ...
    public int updateByUser(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            num = session.update("com.wechat.bus.dao.mapper.User.updateByUser", user);
        } catch (Exception e) {
    ...
    public User selectByUserone(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            userone = session.selectOne("com.wechat.bus.dao.mapper.User.selectByUserone", user);
        } catch (Exception e) {
    ...
    public int selectCountByUser(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            num = session.selectOne("com.wechat.bus.dao.mapper.User.selectCountByUser", user);
        } catch (Exception e) {
    ...
    public List<User> selectByUserList(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            userList = session.selectList("com.wechat.bus.dao.mapper.User.selectByUserList", user);
        } catch (Exception e) {
    ...
    public int selectCountBySelectData(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            num = session.selectOne("com.wechat.bus.dao.mapper.User.selectCountBySelectData", user);
        } catch (Exception e) {
    ...
    public List<User> selectBySelectData(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            user1List = session.selectList("com.wechat.bus.dao.mapper.User.selectBySelectData", user);
        } catch (Exception e) {
    ...
    public int updateByUserDeleteState(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            num = session.update("com.wechat.bus.dao.mapper.User.updateByUserDeleteState", user);
        } catch (Exception e) {
    ...
    public int deleteByUser(SqlSession session, User user) {
        ...
        try {
            logger.info("UserDao");
            num = session.delete("com.wechat.bus.dao.mapper.User.deleteByUser", user);
        } catch (Exception e) {
    ...
    public int deleteByidlist(SqlSession session, String id) {
        ...
        try {
            logger.info("UserDao");
            num = session.delete("com.wechat.bus.dao.mapper.User.deleteByidlist", id);
        } catch (Exception e) {
